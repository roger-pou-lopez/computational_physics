                    ...
                    for(iner=0;iner<INER;iner++)
                        {
                           ...
                           // cambio_tentativo_A(K,K_aux);
                            ...
                            #ifdef DEBUG
                            {
                                for(i=0;i<N+1;i++)
                                    {
                                    printf("K[%d]:%d,K_aux[%d]:%d,Ener:%lf\n",i,K[i],i,K_aux[i],Ener);
                                    }
                                printf("\n\n");
                            }
                            #endif // DEBUG
                          ...
                          /* if(exp(-Ener)>Random())
                                ...
                                #ifdef DEBUG
                                printf("Resto_n final :%lf\n\n",Resto_n);
                                 printf("iner:%d,INER:%d\n",iner,INER);
                                #endif // DEBUG6

                            fprintf(fout,"%lf %d %d %lf %lf\n",beta,tot,acept,Resto,Resto_n);
...
void cambio_tentativo_B(int *K,int *K_aux)
{
    ...
    printf("a:%d,b:%d,delta:%d,intervalo1:%d\n",a,b,delta,a+delta);
